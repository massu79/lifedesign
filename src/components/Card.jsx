...
const Card = ({ children, className, hoverEffect = true, glow = false }) => {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 border border-[var(--color-border)] rounded-xl pointer-events-none group-hover:border-[var(--color-border-glow)] transition-colors"></div>
